...
const CONTACT = {
  title: "Aloqa",
  desc:
    "Savolingiz bormi yoki buyurtma bermoqchimisiz? Formani to‘ldiring, xabar email orqali tayyor holatda ochiladi.",
  // o'zing almashtirib olasan:
...
export default function Aloqa() {
  ...
  const errors = useMemo(() => {
    ...
    else if (form.message.trim().length < 10) e.message = "Xabar kamida 10 ta belgi bo‘lsin.";
    return e;
  }, [form]);
  ...
  const buildMailto = () => {
    const subject = `[Sayt] ${form.subject}`;
    const body = [
      `Ism: ${form.fullName}`,
      `Telefon: ${form.phone}`,
      `Email: ${form.email}`,
    ...
    return `mailto:${CONTACT.toEmail}?subject=${encodeURIComponent(
      subject
  ...
  const onSubmit = (e) => {
    ...
    // mail clientni ochadi
    window.location.href = buildMailto();

    // xohlasang formani tozalaymiz:
      ...
      <div className="container">
        ...
        <div className="contact__grid">
          ...
          <aside className="contact__info">
            ...
            <a className="info-card" href={`mailto:${CONTACT.info.email}`}>
          ...
          <div className="contact__form">
            <div className="contact__formHead">
              ...
              <p className="contact__formSub">
                “Yuborish” bosilganda email dasturingiz ochiladi va xabar tayyor bo‘ladi.
              </p>
            </div>
              ...
              <div className="form-grid">
                ...
                <div className={`form-field full ${touched.message && errors.message ? "is-error" : ""}`}>
                  ...
                  {touched.message && errors.message ? (
                    ...
                    <div className="field-hint">{form.message.trim().length}/500</div>
                  )}
                </div>
              </div>
